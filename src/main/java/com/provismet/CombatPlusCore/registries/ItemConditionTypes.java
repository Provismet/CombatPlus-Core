...
import com.provismet.CombatPlusCore.enchantment.loot.condition.item.IsDualWeapon;
import com.provismet.CombatPlusCore.enchantment.loot.condition.item.IsMeleeWeapon;
...
public class ItemConditionTypes {
    ...
    public static final LootConditionType IS_MELEE_WEAPON = register("is_melee_weapon", IsMeleeWeapon.CODEC);
    public static final LootConditionType IS_DUAL_WEAPON = register("is_dual_weapon", IsDualWeapon.CODEC);
